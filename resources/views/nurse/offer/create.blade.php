...
<div class="container">
    <h1 class="mt-4">Añadir servicio realizado</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Añadir servicio realizado</li>
    </ol>
    ...
    @foreach ($services as $service)
        ...
        <div class="col-md-4 col-6">
            ...
            <div class="caption">
                ...
                <form action="{{route('nurse.offer.store',$service->id)}}" method="POST">
                    {{ csrf_field() }}
