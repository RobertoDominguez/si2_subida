...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="{{ route('nurse.menu') }}">Tablero</a><button
        ...
        <ul class="navbar-nav ml-auto ml-md-0">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    ...
                    <form action="{{ route('nurse.logout') }}" method="POST">
                        {{ csrf_field() }}
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ route('nurse.offer.index') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Mis servicios
                        </a>

                        <a class="nav-link" href="{{ route('nurse.invoice.pending') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Agenda de citas pendiente
                        </a>

                        <a class="nav-link" href="{{ route('nurse.invoice.finished') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Agenda de citas pasada
                        </a>
